...
class MemberJpaRepositoryTest {
    ...
    public void basicTest() {
        ...
        List<Member> result4 = memberJpaRepository.findByUsername_querdsl("member1");
    ...
    public void searchTest() {
        ...
        MemberSerchCondition condition = new MemberSerchCondition();
        condition.setAgeGoe(35);
        condition.setAgeLoe(40);
        condition.setTeamName("teamB");

        List<MemberTeamDto> result = memberJpaRepository.searchByBuiler(condition);
